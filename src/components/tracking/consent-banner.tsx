...
export function ConsentBanner() {
  ...
  return (
    <div className="fixed inset-x-3 bottom-[calc(4rem+env(safe-area-inset-bottom)+0.75rem)] z-[70] mx-auto max-w-3xl rounded-2xl border border-butter/30 bg-ink/95 p-4 text-sm text-white shadow-2xl backdrop-blur md:bottom-5 md:p-5">
