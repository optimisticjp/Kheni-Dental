      ...
      */}
      {shown && (
        <>
          ...
          <span
            aria-hidden="true"
            className="pointer-events-none absolute left-1/2 top-1/2 z-20 grid size-9 -translate-x-1/2 -translate-y-1/2 place-items-center rounded-full border-2 border-ivory bg-ink font-serif text-base font-medium text-gold shadow-[0_3px_12px_rgba(0,0,0,.5)]"
          >
            K
          </span>
          <span
