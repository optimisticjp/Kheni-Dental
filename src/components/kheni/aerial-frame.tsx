      ...
      */}
      {shown && (
        <>
          ...
          <span
            aria-hidden="true"
            className="pointer-events-none absolute left-1/2 top-1/2 z-20 grid size-9 -translate-x-1/2 -translate-y-1/2 place-items-center rounded-full border-2 border-white bg-blue font-serif text-base font-semibold text-white shadow-[0_3px_12px_rgba(0,0,0,.5)]"
          >
            K
          </span>
          <span
          ...
          >
            Open in Google Maps
            <ArrowUpRight className="size-3 text-butter" />
          </span>
        </>
      )}
      ...
      <a
        ...
        className="absolute inset-0 z-30 rounded-[inherit] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue"
      >
