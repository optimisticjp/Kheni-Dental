...
export function Legend({ parts, className }: { parts: Part[]; className?: string }) {
  return (
    <ol className={cn("grid gap-2", className)}>
      {parts.map((part) => (
        <li key={part.n} className="flex items-start gap-3 rounded-xl bg-white px-3 py-2.5 ring-1 ring-line">
          <span
            aria-hidden="true"
...
const implantParts: Part[] = [
  ...
  { n: 4, name: "Implant post", note: "Placed in the bone, it holds everything", swatch: "var(--sky-soft)" },
  ...
  return (
    <figure className={cn("grid gap-5 md:grid-cols-[1fr_15rem] md:items-center lg:gap-8", className)}>
      ...
      >
        ...
        {/* implant post */}
        <path d="M138 206h44v96c0 16-10 26-22 30-12-4-22-14-22-30z" fill="var(--sky-fill)" />
        ...
        <Marker x={214} y={262} n={4} swatch="var(--sky-soft)" />
...
const toothParts: Part[] = [
  ...
  { n: 2, name: "Dentin", note: "The softer layer underneath", swatch: "var(--gold-soft)" },
  ...
  return (
    <figure className={cn("grid gap-5 md:grid-cols-[1fr_15rem] md:items-center lg:gap-8", className)}>
      ...
      >
        ...
        {/* dentin */}
        <path d="M160 66c-30 0-46 20-42 54 2 18 8 36 14 52l6 70c1 8 12 8 13 0l9-46 9 46c1 8 12 8 13 0l6-70c6-16 12-34 14-52 4-34-12-54-42-54z" fill="var(--gold-soft)" />
        {/* pulp */}
        ...
        <Marker x={92} y={132} n={2} swatch="var(--gold-soft)" />
...
export function GlobeSurat({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 320 320" className={cn("block", className)} aria-hidden="true" focusable="false">
      ...
      <circle cx="160" cy="170" r="120" fill="var(--sky)" />
      <g clipPath="url(#globe-clip)" stroke="var(--sky-soft)" strokeWidth="2" fill="none">
      ...
      <g transform="translate(152 122)">
        <path d="M0-22c-9 0-16 7-16 16 0 12 16 30 16 30s16-18 16-30c0-9-7-16-16-16z" fill="var(--ink)" stroke="#ffffff" strokeWidth="3" />
        <circle cx="0" cy="-6" r="6" fill="var(--gold)" />
      </g>
      ...
      <path d="M262 236l1.5 3.5 3.5 1.5-3.5 1.5-1.5 3.5-1.5-3.5-3.5-1.5 3.5-1.5z" fill="var(--gold)" />
      <path d="M46 250l2 4 4 2-4 2-2 4-2-4-4-2 4-2z" fill="var(--gold)" />
    </svg>
  );
}
