...
export const metadata: Metadata = {
  alternates: { canonical: "/terms/" }, title: "Terms & Medical Disclaimer", description: "What the information on the Kheni Dental website can and cannot do, why results differ from patient to patient, and what to do if your problem is urgent." };
