...
const trust = [
  ...
  { icon: Globe2, title: "Two clinics across Surat", copy: "Choose between Swastik Plaza and Hirabaug for a visit that fits your day." },
];
...
export default function Home() {
  return (
    <>
        ...
        <Container width="7xl" className="relative grid min-h-[78vh] items-center gap-12 py-14 lg:grid-cols-[1.04fr_.96fr] lg:py-24">
          <div>
            ...
            <div className="mt-8 grid max-w-xl grid-cols-3 divide-x divide-white/10 border-y border-white/10 py-5">
              <div className="pr-4"><p className="font-serif text-2xl text-gold">{site.yearsInSurat}</p><p className="mt-1 text-[.66rem] uppercase tracking-[.14em] text-white/40">Years in Surat</p></div>
              <div className="px-4"><p className="font-serif text-2xl text-gold">4</p><p className="mt-1 text-[.66rem] uppercase tracking-[.14em] text-white/40">Dental professionals</p></div>
              <div className="pl-4"><p className="font-serif text-2xl text-gold">2</p><p className="mt-1 text-[.66rem] uppercase tracking-[.14em] text-white/40">Surat clinics</p></div>
            </div>
          </div>
      ...
      <Section spacing="lg">
        <Container width="7xl">
          <SectionHeading eyebrow="Start with how you feel" title="You do not need to know the treatment name before you call." copy="Find the concern that sounds most like yours. We can explain common options, but the dentist still needs to examine the cause before recommending treatment." />
      ...
      <Section spacing="lg">
        <Container width="7xl">
          <div className="grid gap-12 lg:grid-cols-[.9fr_1.1fr] lg:items-center">
            <div><SectionHeading eyebrow="15 years in Surat" title="Built around conversations patients can understand." copy="Kheni Dental has grown over 15 years in Surat, while keeping the conversation personal. The approach is simple: listen carefully, explain clearly and plan responsibly." /><div className="mt-8 flex flex-wrap gap-3"><Link href="/about" className="rounded-full bg-ink px-5 py-3 text-sm font-semibold text-white">Our story</Link><Link href="/locations" className="rounded-full border border-border px-5 py-3 text-sm font-semibold">Find a branch</Link></div></div>
      ...
      <Section className="bg-[#f1eee7]" spacing="lg">
        <Container width="7xl">
          <SectionHeading eyebrow="Visit us" title="Find your Kheni." copy="Two clinics across Surat, one approach to care. Choose the location that is easier for your day, then open it directly in Google Maps." />
