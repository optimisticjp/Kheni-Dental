...
# Project Overlay: Kheni Elite Dental & Implant Center

This repository is now instantiated for Kheni Elite. Before making product/design changes, read `PROJECT_BRIEF.md`, `CONTENT_NEEDED.md`, `TRACKING_PLAN.md`, `DEPLOYMENT.md`, and `CLAUDE_PROJECT_HANDOFF.md`.

For this project specifically:
- Preserve the premium near-black / warm-off-white / muted-gold visual language unless explicitly changed.
- Use authentic doctor/clinic/patient imagery for production.
- Treat mobile conversion, local search, international patient trust and analytics quality as first-class requirements.
- Do not invent medical claims, credentials, treatment outcomes, reviews, technology, awards or statistics.
- Keep tracked data healthcare-safe and generic.
- Keep all clinic-specific editable data centralized in `src/content/site.ts` where practical.
